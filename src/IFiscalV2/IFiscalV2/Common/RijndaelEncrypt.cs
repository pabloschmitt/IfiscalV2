...
namespace IFiscalV2.Common
{
    ...
    {
        private const string defaultPassPhrase = "sGQrVZWmZ0qKeCuVk5qmYA==";
        ...
        public static string EncryptString(this string sourceText)
        {
            string result = EncryptString(sourceText, defaultPassPhrase);
            return result;
        }

        public static string DecryptString(this string cipherText)
        {
            string result = DecryptString(cipherText, defaultPassPhrase);
            return result;
        }
